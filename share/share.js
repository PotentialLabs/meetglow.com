    ...
    $('.facebook').on('click', function() {
        var w = 580, h = 300,
            ...
            if ((screen.width < 480) || (screen.height < 480)) {
                window.open ('http://hrefshare.com/ba74e', '', 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=no, resizable=no, copyhistory=no, width='+w+', height='+h+', top='+top+', left='+left);
            } else {
                window.open ('http://hrefshare.com/ba74e', '', 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=no, resizable=no, copyhistory=no, width='+w+', height='+h+', top='+top+', left='+left);
            }
    });
